...
export default class Conversor extends Component {
    ...
    async converter(){
      ...
      const response = await api.get(`convert?q=${de_para}&compact=ultra&apiKey=788347d95c514e16ee87`)
    ...
    render() {
        ...
        return (
            <View style={styles.container}>
                ...
                <TextInput  placeholder='Valor para ser convertido'
